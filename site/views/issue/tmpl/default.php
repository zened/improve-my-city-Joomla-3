	...
	<div id="imc-header">
		<div id="imc-menu">
			...
			<?php 
				...
				*/
			?>
			<a class="btn modal btn-success imc-right" rel="{size: {x: 700, y: 500}, handler:'iframe'}" href="<?php echo $url;?>"><i class="icon-print icon-white"></i> <?php echo JText::_('JGLOBAL_PRINT');?></a>
